...
public class GUI extends JFrame {
    ...
    public GUI(Steuerung s) {
        ...
        topContainer.add(createOptionsPanel(), BorderLayout.CENTER);
    ...
    private JPanel createOptionsPanel() {
        ...
        btnStartNew.addActionListener(e -> {
            ...
            dieSteuerung.neuesSpiel(tfPlayer1Name.getText(), tfPlayer2Name.getText(), usePuzzle);
    ...
    private JPanel createMessagePanel() {
        ...
        btnMessageOk.addActionListener(e -> messagePanel.setVisible(false));
    ...
    private JPanel createGameArea() {
        ...
        btnFinish.addActionListener(e -> dieSteuerung.gedrueckt(tfSolution.getText().trim()));
        game.add(loesungRow);

        return game;
    }

    public void anzeigenAufgabe(String aufgabe) {
        puzzleLettersPanel.removeAll();
        if (aufgabe != null && !aufgabe.isEmpty()) {
            for (String s : aufgabe.split("\\s+")) {
    ...
    public void zeigeSpieler(String name1, int punkte1, String name2, int punkte2, String aktiv) {
